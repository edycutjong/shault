<div align="center">
  ...
  [![GitHub](https://img.shields.io/badge/GitHub-Repository-black.svg)](https://github.com/edycutjong/frontier-kirapay)
</div>
...
KiraPay-powered privacy vault ingress. Pay → verify → stealth deposit.
...
1. **Clone the repo:**
   ```bash
   git clone https://github.com/edycutjong/frontier-kirapay.git
   cd frontier-kirapay
   ```
